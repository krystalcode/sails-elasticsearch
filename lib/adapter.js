    ...
    find: function (connectionName, collectionName, options, cb, index) {
      ...
      if (index == undefined) {
        if (config.index != undefined) {
          ...
          return cb(new Error('You must define the index where the collection "' + collectionName + '" should be located.'));
        }
      }
      ...
      client.search({
        ...
        /**
         * @Issue(
         *   "Check whether we should be returning the user objects instead of
         *   the Elastic Search response"
         *   type="bug"
         *   priority="normal"
         *   labels="api compliance"
         * )
